...
struct Country {
    ...
    init(named: String, covidData: JSON, vaccineData: JSON) {
        ...
        if name == "United States" {
            ...
            percentVaccinated = Country.intToPercentString(number: vaccineData[named]["All"]["people_vaccinated"].intValue, isWhatPercentOf: covidData["US"]["All"]["population"].intValue)
        } else {
